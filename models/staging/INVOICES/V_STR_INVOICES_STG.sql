...
--DLHK
  ...
  ,C.K_BALANCE_TRANSACTION_DLHK AS K_CHARGE_BALANCE_TRANSACTION_DLHK
  ,I.K_CHARGE_DLHK
  ,I.K_CUSTOMER_DLHK
--BK
  ...
  ,C.A_STATUS AS A_CHARGE_STATUS
  ,C.A_CREATED_AT AS A_CHARGE_CREATED_AT
...
FROM 
  ...
  LEFT JOIN charges C ON C.K_CHARGE_DLHK = I.K_CHARGE_DLHK
)
