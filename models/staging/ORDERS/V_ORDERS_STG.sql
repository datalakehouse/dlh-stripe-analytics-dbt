...
SELECT DISTINCT 
  ...
  ,MD5(COALESCE(S.BUDGET_ID,'000000000000')) AS K_BUDGET_DLHK
  ,MD5(COALESCE(S.MERCHANT,'000000000000')) AS K_MERCHANT_DLHK
  ,MD5(COALESCE(S.TEAM_ACCOUNT,'000000000000')) AS K_TEAM_ACCOUNT_DLHK
  ...
  ,DELIVERY_ADDRESS AS A_DELIVERY_ADDRESS
